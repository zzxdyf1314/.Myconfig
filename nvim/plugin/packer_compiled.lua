...
_G.packer_plugins = {
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
    url = "https://github.com/akinsho/bufferline.nvim"
  },
  ["lualine-lsp-progress"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/lualine-lsp-progress",
  ...
  melange = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/melange",
    url = "https://github.com/savq/melange"
  },
  ["nvcode-color-schemes.vim"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/nvcode-color-schemes.vim",
  ...
  ["oceanic-next"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/oceanic-next",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/home/patrick/.local/share/nvim/site/pack/packer/start/vim-bbye",
